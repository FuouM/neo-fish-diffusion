...
from whisper.whisper import _MODELS, log_mel_spectrogram, pad_or_trim
from whisper.whisper.model import AudioEncoder, LayerNorm, ResidualAttentionBlock, sinusoids
